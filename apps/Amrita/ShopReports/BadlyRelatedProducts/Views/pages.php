<div class="row">
    ...
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
        <ul id="sparks" class="list-actions list-unstyled list-inline">
            <li>
                <a class="btn btn-default" href="./admin/shop/reports/<?php echo $report->slug; ?>/posts">Go to Blog Posts</a>
            </li>        
            <li>
                <a class="btn btn-info" href="./admin/shop/reports/<?php echo $report->slug; ?>/populate">Refresh</a>
            </li>        
            <li>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-4">
            ...
            <ul class="list-filters list-unstyled list-inline">
                ...
                <li>
                    <a class="btn btn-danger" href="./admin/shop/reports/<?php echo $report->slug; ?>/disassociate-all">Disassociate All</a>
                </li>                
            </ul>
            </div>
        </div>
            ...
            <?php if (!empty($paginated->items)) { ?>
                ...
                <?php foreach($paginated->items as $key=>$item) { ?>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div>
                                <a class="btn btn-warning" href="./admin/shop/reports/<?php echo $report->slug; ?>/disassociate/<?php echo $item->id; ?>">Disassociate</a>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div>
                        ...
                        <div class="col-sm-3">
                            <p>
                                <b><?php echo $item['page_title']; ?></b>
                            </p>
                            <p>
                            Page ID: <?php echo $item['page_id']; ?>
                            </p>
                        </div>
                        <div class="col-sm-3">
