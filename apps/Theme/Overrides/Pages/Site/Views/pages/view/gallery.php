...
<div class="container">
    <ol class="breadcrumb">
        <li>
            <a href="./pages/category/amritasingh-gallery">amritasingh gallery</a>
        </li>
                ...
                <?php 
                	...
                	foreach ($related_products as $product_id) {
                    	$product = (new \Shop\Models\Products)->setState('filter.id', $product_id)->getItem();
                       	...
                       	$js = '';
                       	if( $is_kissmetrics ){
							$js ="\" onclick=\"javascript:_kmq.push(['record', 'Gallery Related Items', {'Product Name' : '".$product->title."', 'SKU' : '".$product->{'tracking.sku'}."' }])";
