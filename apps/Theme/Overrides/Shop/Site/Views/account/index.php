<div class="container">
    ...
    <?php $loyalty_level = \Amrita\Models\Customers::loyaltyLevel($this->auth->getIdentity()->reload()); ?>
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4">
                    <legend>Loyalty Program</legend>
                    <p class="help-block"><small>Complete details on our loyalty program are available here: <a href="./pages/loyalty-program">Loyalty Program</a></small></p>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-8">
                    <h4>Your Level: <span class="label label-success <?php echo $loyalty_level ? $loyalty_level['slug'] : null; ?>"><?php echo $loyalty_level ? $loyalty_level['title'] : 'Registered Shopper'; ?></span></h4>
                    <?php if ($loyalty_level) { ?>
                        <?php if (!empty($loyalty_level['campaign'])) { ?>
                            <h4>Expires: <small><?php echo date('Y-m-d', $loyalty_level['campaign']['expires']['time'] ); ?></small></h4>
                        <?php } ?>
                    <?php } ?>                
                </div>
            </div>
