<?php if (!empty($paginated->items)) { ?>
            ...
            <div class="page-counter pull-left">
                <div class="type-selector">
                    <span class="pagination">
                        ...
                        <a href="./shop/collection/<?php echo $collection->slug; ?>/view-all" class="btn btn-default btn-sm custom-button">View all</a>
                    </span>
                </div>
            </div>
        </div>
    ...
    <?php foreach ($paginated->items as $position=>$item) { ?>
        ...
        <article itemscope itemtype="http://schema.org/Product" class="category-article category-grid col-sm-3">
            <figure>
