...
<?php echo $this->renderLayout('Shop/Admin/Views::products/fields_pricinginventory_shipping.php'); ?>
...
<?php echo $this->renderLayout('Shop/Admin/Views::products/fields_pricinginventory_specialpricing.php'); ?>