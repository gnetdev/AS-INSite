...
<form class="searchForm" method="post" action="./admin/shop/orderfailures">
                ...
                <div class="col-xs-12 col-sm-5 col-md-3 col-lg-3">
                    ...
                    <div class="input-group">
                        <select id="bulk-actions" name="bulk_action" class="form-control">
                            ...
                            <option value="delete" data-action="./admin/shop/orderfailures/delete">Delete</option>
                        </select>
                        <span class="input-group-btn">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            ...
                            <div><label>#</label><a href="./admin/shop/orderfailure/edit/<?php echo $order->id; ?>"><?php echo $order->{'number'}; ?></a></div>
