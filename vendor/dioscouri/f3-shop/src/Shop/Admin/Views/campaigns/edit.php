        ...
        <div class="col-md-12">
            ...
            <div class="clearfix">
                ...
                <div class="pull-right">
                    ...
                    &nbsp;
                    <a class="btn btn-default" href="./admin/shop/campaigns">Cancel</a>
                </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab-basics">
                    ...
                    <?php echo $this->renderLayout('Shop/Admin/Views::campaigns/fields_basics.php'); ?>
                ...
                <div class="tab-pane" id="tab-rules">
                    ...
                    <?php echo $this->renderLayout('Shop/Admin/Views::campaigns/fields_rules.php'); ?>
                ...
                <div class="tab-pane" id="tab-rewards">
                    ...
                    <?php echo $this->renderLayout('Shop/Admin/Views::campaigns/fields_rewards.php'); ?>
