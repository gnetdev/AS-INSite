...
class Package
{
     ...
     *            the weight of the package - do NOT enclose in quotes!
     * @param array $dimensions
     *            - array elements can be integers or floats - do NOT enclose values in quotes!
     * @param array $options            
     */
    ...
    protected function isPackageValid()
    {
        ...
        foreach ($values as $value)
        {
            ...
            else
            {
                ...
                if (!filter_var($this->{$value}, FILTER_SANITIZE_NUMBER_INT) && !filter_var($this->{$value}, FILTER_SANITIZE_NUMBER_FLOAT))
                {
                    // add the invalid property to the array
                    $invalid_properties .= $value . ', ';
                }
        ...
        {
            throw new \UnexpectedValueException('Package object is not valid.  Properties (' . $invalid_properties . ') are invalid or not set.');
        }
        else
        {
            return true;
     ...
     *            the width of the package (if null, the object property $this->width will be used)
     * @param int|float $height
     *            the height of the package (if null, the object property $this->height will be used)
     * @version updated 01/14/2013
     * @since 12/04/2012
     ...
     * @since 01/01/2013
     * @param string $key
     *            the desired key of the options array
